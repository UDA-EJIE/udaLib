 ...
 */
public class X38TestingLoggingWebContextLoader extends AbstractContextLoader {
	protected final MockServletContext servletContext;

	public X38TestingLoggingWebContextLoader(String warRootDir, boolean isClasspathRelative) {
	...
	private MockServletContext initServletContext(String warRootDir, ResourceLoader resourceLoader) {
		...
		mockServletContext.setContextPath("/x38TestingLoggingWar");
