	...
	public HashMap<String, String> getUserDataInfo(HttpServletRequest httpRequest, boolean isCertificate) {
		...
		if (fullName != null) {
			...
			if (!(XlnetCore.getParameterSession(n38Api, "n38uidOrg").equals("0"))) {
				...
				// En caso de autenticaciÃƒÂ³n mediante juego de barcos el campo CN tendrÃƒÂ¡ 
				// el valor de la propiedad dni del xml de sesiÃƒÂ³n de XLNetS
			...
			try {
				...
				if (XlnetCore.isXlnetSessionContainingErrors(xmlSesion)
					...
					if (!(XlnetCore.getParameterSession(n38Api, "n38uidOrg").equals("0"))) {
						...
						// campo CN tendrÃƒÂ¡ el valor de la propiedad dni del xml
						// de sesiÃƒÂ³n de XLNets.
