 ...
 */
public class X38TestingPibWebContextLoader extends AbstractContextLoader {
	protected final MockServletContext servletContext;

	public X38TestingPibWebContextLoader(String warRootDir, boolean isClasspathRelative) {
	...
	private MockServletContext initServletContext(String warRootDir, ResourceLoader resourceLoader) {
		...
		mockServletContext.setContextPath("/x38TestingPibWar");
