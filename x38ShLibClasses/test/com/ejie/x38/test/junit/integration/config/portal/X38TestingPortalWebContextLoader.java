 ...
 */
public class X38TestingPortalWebContextLoader extends AbstractContextLoader {
	protected final MockServletContext servletContext;

	public X38TestingPortalWebContextLoader(String warRootDir, boolean isClasspathRelative) {
	...
	private MockServletContext initServletContext(String warRootDir, ResourceLoader resourceLoader) {
		...
		mockServletContext.setContextPath("/x38TestingPortalWar");
