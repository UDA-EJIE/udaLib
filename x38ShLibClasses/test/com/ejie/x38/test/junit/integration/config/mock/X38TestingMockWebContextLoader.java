 ...
 */
public class X38TestingMockWebContextLoader extends AbstractContextLoader {
	protected final MockServletContext servletContext;

	public X38TestingMockWebContextLoader(String warRootDir, boolean isClasspathRelative) {
	...
	private MockServletContext initServletContext(String warRootDir, ResourceLoader resourceLoader) {
		...
		mockServletContext.setContextPath("/x38TestingMockWar");
