 ...
 */
public class X38TestingWrongWebContextLoader extends AbstractContextLoader {
	protected final MockServletContext servletContext;

	public X38TestingWrongWebContextLoader(String warRootDir, boolean isClasspathRelative) {
	...
	private MockServletContext initServletContext(String warRootDir, ResourceLoader resourceLoader) {
		...
		mockServletContext.setContextPath("/x38TestingWrongWar");
